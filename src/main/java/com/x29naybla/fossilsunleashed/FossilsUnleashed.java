package com.x29naybla.fossilsunleashed;
...
@Mod(FossilsUnleashed.MOD_ID)
public class FossilsUnleashed {
    public static final String MOD_ID = "fossilsunleashed";
    private static final Logger LOGGER = LogUtils.getLogger();

    public FossilsUnleashed(IEventBus modEventBus, ModContainer modContainer) {
